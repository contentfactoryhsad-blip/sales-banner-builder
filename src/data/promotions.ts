...
export const PROMOTIONS: Promotion[] = [
  ...
  /*
    2026-09-16 확정 — 메인은 **Active Red 와 구 LG Red 의 중간색**이다.
    순수 Active Red(#fd312e)만 쓰면 너무 형광에 가깝고, 구 LG Red(#a50013)만 쓰면
    어두워서 절반씩 섞었다. 보조색은 Warm Gray 06(#f0ece4)이 너무 옅어 배너에서
